...
/**
 * Test cases for activity predictions on device using machine learning models.
 */
...
public class ActivityPredictionsOnDeviceTest extends BaseAndroidTestCase {
	...
	private void testActivityTypeByStartTimePrediction(final LocalDate date, final LocalTime startTime, LocalTime endTime, long expectedActivityTypeId)
		...
		LOG.info(
			"Predicting Activity Type for " + startTime + " - " + endTime + ", expected  " + expectedActivityTypeId + ", got " + getName(mostLikely) + " " + last);
