...
public class SimplePredictionsTest extends BaseAndroidTestCase {
    ...
    private void assertCategoryPrediction(final ActivityCategoryByStartTimePrediction prediction, final LocalDate date, final LocalTime startTime, long expectedCategoryId) {
