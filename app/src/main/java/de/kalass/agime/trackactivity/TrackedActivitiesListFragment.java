 ...
 *
 */
public class TrackedActivitiesListFragment extends BaseListFragment
        implements
        LoaderManager.LoaderCallbacks<TrackedActivityListData>,
        CABMultiChoiceCallback, ObservableScrollViewCallbacks, ResizableToolbarHelper.ToolbarResizeCallback {
    ...
    protected void doInitialScroll(final int maxToolbarHeight, final int minToolbarHeight) {
        ...
        _listView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Log.d("Frg", "cc: " + cc + ", footerTop -> " + footerTop + ", footerIsVisible: " + footerIsVisible + ", screenHeight: " + screenHeight + ", firstPos: " + firstPos + ", lastPos: " + lastPos + " adapter size " + _listView.getAdapter().getCount());
                ...
                if (isContentSizeCorrect && contentSize < minNeededSize) {
                    ...
                    Log.d("Frg", "screenHeight: " + screenHeight + ", minToolbarHeight: " + minToolbarHeight + ", header bottom " + header.getBottom() + ", footerTop " + footerTop + " => missing: " + missingArea);
        ...
        _powerConnectionReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(final Context context, final Intent batteryStatus) {
                ...
                if (_screenOnWakelock != null && !isCharging) {
                    ...
                    /**
                     * We use the deprecated SCREEN_DIM_WAKE_LOCK, because the alternative
                     * FLAG_KEEP_SCREEN_ON will keep the screen bright, which is not the desired behaviour
                     */
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                case ACTIVITY_CODE_EDIT:
                case ACTIVITY_CODE_TRACK_TIME:
