...
public class ActivityTypeEditorFragment extends AnalyticsBaseCRUDFragment<ActivityTypeEditorFragment.ActivityTypeFragmentView, ActivityTypeEditorFragment.ActivityTypeFragmentData> implements AutoCompleteSpinner.OnItemSetListener {
	...
	public void onItemSet(AutoCompleteSpinner spinner, boolean userSelectedExplicitely, int position, long itemId) {
		...
		if (spinnerId == ActivityTypeFragmentView.ID_CATEGORY) {
