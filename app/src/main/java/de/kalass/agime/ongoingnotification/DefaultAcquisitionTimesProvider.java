...
/**
 * Default implementation of AcquisitionTimesProvider that retrieves data from the database via ContentProvider. This is
 * the production implementation used in the real app.
 */
