...
/**
 * Interface for providing AcquisitionTimes data. This abstraction allows for dependency injection and easier testing by
 * decoupling the NotificationWorker from direct database access.
 */
