 ...
 */
public class AcquisitionTimeManagementActivity extends AnalyticsActionToolBarActivity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener, LinearListView.OnItemClickListener {
	...
	public void onClick(View v) {
		int viewId = v.getId();
		if (viewId == WrappedView.ID_INSERT_RECURRING_ACQUISITION_TIME_BUTTON) {
	...
	public void onItemClick(LinearListView linearListView, View view, int position, long l) {
		...
		if (listViewId == WrappedView.ID_RECURRING_ACQUISITION_TIMES_LIST) {
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
		...
		if (loaderId == RECURRING_LOADER_ID) {
			setCursor(cursor);
