 ...
 */
public class CustomFieldTypeEditorFragment extends AnalyticsBaseCRUDFragment<CustomFieldTypeEditorFragment.WrappedView, CustomFieldTypeEditorFragment.CustomFieldTypeEditorData> implements CompoundButton.OnCheckedChangeListener {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		if (buttonId == WrappedView.ID_PROJECT_DEPENDEND_SWITCH) {
	...
	static final class CustomFieldTypeProjectListAdapter extends BaseListAdapter<ProjectWrappedView, ProjectSelectedItem> implements CompoundButton.OnCheckedChangeListener {
		...
		public void bindWrappedView(ProjectWrappedView view, ProjectSelectedItem model, int position) {
			...
			view.name.setText(name);
			view.name
				.setTextColor(getContext().getResources().getColor(model.project.isInactive() ? R.color.material_black_text_disabled : R.color.material_black_text));
