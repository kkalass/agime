...
/**
 * Base class for Fragments that implement insert/edit/view/delete for some type - including
 * complex types that consist of multiple entities within the same data provider.
 *
 ...
 */
public abstract class BaseCRUDFragment<C, D> extends Fragment
    implements LoaderManager.LoaderCallbacks<D>,
         BaseCRUDDBUtil.DeletionCallback
{
    ...
    /**
     * Bind the data to the view. Note that data may be null, most commonly when in insert mode.
     * But wether or not data is null, is determined by the implemenation of the data loading
     */
    ...
    /**
     * Creates a ContentProviderOperation for inserting or updating the main entity of this fragment,
     * ensuring that common data like "modified at" or "created at" is provided.
     */
