...
public abstract class BaseCRUDActivity extends AppCompatActivity implements BaseCRUDFragment.CRUDListener {
	...
	/**
	 * @return the set of CRUDModes you support directly. The default is EDIT and INSERT, because Intents for VIEW or
	 *         DELETE can be handled by an EDIT mode as well.
	 *
	...
	private void setupToolbarInsets() {
		// Apply system window insets to the toolbar to handle status bar
		Toolbar toolbar = getToolbar();
		if (toolbar != null) {
